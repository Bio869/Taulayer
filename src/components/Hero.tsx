          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 rounded-full text-sm font-medium text-primary">
                ...
                Smarter AI Workflows — Perform. Save. Scale
              </div>
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Prompt- and backend-triggered requests often lead to high-cost, high-latency workloads—τLayer reveals and mitigates system load before execution.
              </p>
            </div>
