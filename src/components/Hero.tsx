          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-foreground leading-tight">
                Eliminate AI
                <span className="bg-gradient-primary bg-clip-text text-transparent"> Latency</span>
                <br />
                Maximize
                <span className="bg-gradient-accent bg-clip-text text-transparent"> Engagement</span>
              </h1>
